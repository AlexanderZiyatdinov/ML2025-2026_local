...
А [вот она](https://github.com/AlexanderZiyatdinov/ML2025-2026_local/tree/main)

# Как будет проходить курс
* Будут онлайн пары. 1 лекция и 1 практика.
* Будут МЛ-контесты на платформе [kaggle](https://www.kaggle.com/).
* Домашки в ноутбуках с **автоматической** и ручной проверкой.

## Онлайн пары
* На каждой неделе по 2 пары.
* Лектор будет вести рассказ о машинном обучении с точки зрения математики и здравого смысла. В целом, по материалам можно погрузиться в тему и без участия лектора, ценой несколько больших мозговых усилий и воли к осознанию:) Также материалы не содержат баек и ответов на возникающие по ходу прочтения вопросы.
* Посещаемость лекций на оценку по курсу не влияет.
* Записи всех лекций будут размещаться [здесь]().

## Домашки
* Домашки появляются [здесь]() каждую неделю после лекции. Формат сдачи ДЗ определяется преподавателем - практиком. Это может быть сдача через github, эл. почту, ТГ и т.п.
* Домашки со строгим дедлайном, вот коэффицменты:
  * Сдаешь в течение одной недели = 1.0
  * Сдаешь позже = 0.5
  * Если сделал домашку до окончания дедлайна, то есть возможность **дорешки** в течение недели. При сдаче домашки после дедлайна такой возможности нет :(
